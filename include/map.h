...
public:
	int score = 0, score2 = 0, ter = 0, choice = 1, timeInt = 20;

	int mapf[18][32] = {};  //wid x len = 18 x 32   //mapf[18][32];    //mapf[wid][len]
	//int map1[18][32], map2[18][32], map3[18][32], map0[18][32];  

	static int map0[18][32];
	static int map1[18][32];
	static int map2[18][32];
	static int map3[18][32];
	...
	void print_map(int mapp[18][32]);   //mapp[wid][len]
	...
	void do_delete(int& x, int& y, int mapp[18][32]);
	...
	void change_block(int& x, int& y, int mapp[18][32]);
	void change_block2(int& x, int& y, int mapp[18][32]);
	bool not_move(int& x, int& y, int& prex, int& prey);
	void copymap(int mapp[18][32]);
